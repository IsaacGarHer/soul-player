...
const MusicDataProvider = ({ children }) => {
  ...
  const value = {
    ...
    setArtistsPath: setArtistsPath,
    closePanel: closePanel,
    definePath: definePath,
    audioFilesFilter: audioFilesFilter,
    albumFilter: albumFilter,
    toTimeFormat: toTimeFormat,
    embedMeta: embedMeta,
    optimizerOfWork: optimizerOfWork,
    orderByName: orderByName,
    musicFilesUploader: musicFilesUploader,
    artistsImagesUploader: artistsImagesUploader,
